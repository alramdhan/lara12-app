...
@section('title', 'Login | Laravel 12')
  ...
  <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
    ...
    <div class="col-md-6">
      <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
        <div class="bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image: url('../assets/img/banner-login.png'); background-position: right; background-size: cover; transform: skewX(10deg) !important;"></div>
      </div>
    </div>
  </div>
</div>
