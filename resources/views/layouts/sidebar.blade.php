  ...
  <div class="navbar-wrapper">
    <div class="m-header flex items-center py-4 px-6 h-header-height">
      <a href="{{ route('dashboard') }}" class="b-brand flex items-center gap-3">
        ...
        <!-- <img src="{{ asset('assets/img/logo-cf.svg') }}" class="img-fluid" alt="logo" width="100" /> -->
        <img src="https://www.cifor-icraf.org/wp-content/uploads/2021/04/cropped-cifor-icraf-favicon-01-192x192.png" class="img-fluid" alt="logo" width="40" />
      </a>
    </div>
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="{{ route('prompt-ai') }}" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#" class="pc-link">
            ...
            <span class="pc-mtext">Footer Text</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#" class="pc-link">
            <span class="pc-micon"> <i data-feather="share-2"></i></span>
            <span class="pc-mtext">Social Media</span>
          </a>
        </li>
        <li class="pc-item pc-caption">
